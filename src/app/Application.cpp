...
namespace dolbuto
{
    ...
    void Application::run()
    {
        while (!glfwWindowShouldClose(window_))
        {
            ...
            renderer_->drawFrame(renderCamera, renderCameraPosition, debugText_.data(), debugTextVisible_, terrainWireframe_, screenshotRequested_, showPlayer, playerPosition_, camera_.yaw());
