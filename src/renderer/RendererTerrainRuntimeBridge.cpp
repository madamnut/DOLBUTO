...
namespace dolbuto
{
    ...
    world::TerrainBuilderConfig RendererTerrainRuntimeBridge::terrainBuilderConfig() const
    {
        ...
        config.terrainNoiseFeatureScale = client_.worldConfig.terrainNoiseFeatureScale;
        config.terrainNoiseOctaveCount = client_.worldConfig.terrainNoiseOctaveCount;
        config.terrainNoiseLacunarity = client_.worldConfig.terrainNoiseLacunarity;
        config.terrainNoiseGain = client_.worldConfig.terrainNoiseGain;
        config.terrainNoiseSimplexScale = client_.worldConfig.terrainNoiseSimplexScale;
        config.terrainDomainWarpEnabled = client_.worldConfig.terrainDomainWarpEnabled;
        config.terrainDomainWarpAmplitude = client_.worldConfig.terrainDomainWarpAmplitude;
        config.terrainDomainWarpFrequency = client_.worldConfig.terrainDomainWarpFrequency;
        config.terrainDomainWarpOctaveCount = client_.worldConfig.terrainDomainWarpOctaveCount;
        config.terrainDomainWarpGain = client_.worldConfig.terrainDomainWarpGain;
